  ...
  return (
    <section className="clinic-panel rounded-2xl p-5 md:p-6">
      <div className="flex flex-col gap-3 border-b border-slate-200 pb-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <button type="button" onClick={isEditorOpen ? closeEditor : openCreateEditor} className="inline-flex w-fit items-center gap-2 rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50"><Edit3 className="h-4 w-4 text-teal-700" />{isEditorOpen ? t('Close editor') : t('Add user')}</button>
      </div>
