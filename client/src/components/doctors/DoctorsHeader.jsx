    ...
    <section className="rounded-3xl border border-slate-300 bg-white p-6 shadow-sm">
      <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
        <div className="space-y-2">
          ...
          <h1 className="text-3xl font-semibold tracking-tight text-slate-950">Doctors</h1>
          <p className="text-sm text-slate-700">
            Search all doctors and manage clinical staff records.
          </p>
        </div>
      ...
      <div className="mt-5 border-t border-slate-300 pt-5">
        <label className="relative block">
          ...
          <input
            ...
            placeholder="Search all doctors by name, email, phone or specialty"
