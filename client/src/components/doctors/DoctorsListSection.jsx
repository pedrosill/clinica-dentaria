      ...
      <div className="flex flex-col gap-2 border-b border-slate-300 pb-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="text-sm text-slate-700">
            All existing staff records. Double-click a card to open the doctor profile.
          </p>
        </div>
      ...
      <div className="mt-5 space-y-4">
        {doctors.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-slate-300 bg-slate-50 px-6 py-10 text-center">
            <p className="text-sm font-medium text-slate-800">No matching doctors found</p>
            <p className="mt-2 text-sm text-slate-600">
              Try a different name, specialty, email or phone number.
            </p>
          </div>
        ) : (
          doctors.map((doctor) => (
                ...
                <div className="flex min-w-0 items-start gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    {doctor.specialty ? (
                      ...
                      <p className="mt-1 text-sm text-slate-500">No specialty added.</p>
                    )}
