  ...
  async function handleSubmit(event) {
    ...
    try {
      if (mode === 'mfa') {
        ...
        if (newPassword.length < MIN_PASSWORD_LENGTH) throw new Error(t(`Use at least ${MIN_PASSWORD_LENGTH} characters for the new password.`));
