...
const AUTHORIZATION_MATRIX = Object.freeze({
  admin: Object.freeze({
    ...
    clinical: Object.freeze(['read', 'write', 'transcribe', 'validate']),
    compliance: Object.freeze(['read', 'write', 'approve']),
    governance: Object.freeze(['read', 'write', 'export', 'manage']),
  ...
  receptionist: Object.freeze({
    ...
    recall: Object.freeze(['read', 'write']),
    waitlist: Object.freeze(['read', 'write']),
    clinical: Object.freeze(['read', 'write', 'transcribe']),
    compliance: Object.freeze(['read', 'write']),
    governance: Object.freeze(['read', 'write', 'export']),
    report: Object.freeze(['read']),
  }),
  dentist: Object.freeze({
    ...
    clinical: Object.freeze(['read', 'write', 'transcribe', 'validate']),
    compliance: Object.freeze(['read']),
    governance: Object.freeze(['read', 'write', 'manage']),
    settings: Object.freeze(['read']),
    recall: Object.freeze(['read', 'write']),
    waitlist: Object.freeze(['read', 'write']),
    report: Object.freeze(['read']),
